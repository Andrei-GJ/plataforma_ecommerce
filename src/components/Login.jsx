            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-8">
              <div className="w-full max-w-sm">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    type="button"
                    className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-full shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                  >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="appearance-none rounded-full relative block w-full px-4 py-2.5 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="appearance-none rounded-full relative block w-full px-4 py-2.5 pr-12 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm"
                        placeholder=""
                      />
                      <button
                        type="button"
